...
const PrivacyPolicy = () => {
  return (
    <StyledPrivacyPolicy>
      ...
      <p>
        Chase Manning built the Haply app as a Freemium app. This SERVICE is
        provided by Chase Manning at no cost and is intended for use as is.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at Haply unless otherwise
      ...
      <p>This policy is effective as of 2020-11-01</p>{" "}
      <p>
        <strong>Contact Us</strong>
      </p>{" "}
      <p>
        If you have any questions or suggestions about my Privacy Policy, do not
        hesitate to contact me at hello@haply.app.
      </p>{" "}
    </StyledPrivacyPolicy>
  );
};
